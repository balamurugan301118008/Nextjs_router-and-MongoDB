...
export default function AdminAndMangerLogin() {
    ...
    const handleSubmit = (e) => {
        ...
        if (validate()) {
            ...
            notification.error({ description: "validation is not proper" });
        }
        ...
        <div>
            <div className='container w-50 p-20'>
                ...
                <form className='container-fluid m-10' onSubmit={handleSubmit}>
                    ...
                    <div>
                        <p className='p-3'>Already have an account  <Link href='/adminOrManagerRegister' className='btn btn-light border-secondary'>Register</Link></p>
                    </div>
                </form>
            </div>
        </div>
