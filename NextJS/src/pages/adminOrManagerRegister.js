...
export default function AdminAndManagerRegister() {
    ...
    const handleSubmit = (e) => {
        ...
        if (validate()) {
            ...
            // navigate.push('/adminOrManagerRegister')
        ...
        <div>
            ...
            <div className='container w-50 p-20'>
                ...
                <form className='container-fluid m-10' onSubmit={handleSubmit}>
                    ...
                    <div>
                        <p className='p-3'>Already have an account  <Link href='/adminOrManagerLogin' className='btn btn-light border-secondary'>Login</Link></p>
                    </div>
                </form>
            </div>
        </div>
