...
function userRegister() {
    ...
    return (
        <div>
            ...
            <div className='container w-50 p-10'>
                <div>
                    <h1 className='signUp ml-10'> User Sign up</h1>
                </div>
                <form className='container-fluid m-5' onSubmit={handleSubmit}>
                    ...
                    <div>
                        <p className='p-3'>Already have an account  <Link href='/userLogin' className='btn btn-light border-secondary'>Login</Link></p>
                    </div>
                </form>
            </div>
        </div>
