...
export default function ViewTasks() {
    ...
    const handleSubmit = (e) => {
        ...
        if (validate()) {
            ...
            axios.post(`http://localhost:4000/managerHome/viewTasks/${userId}`, TaskData, { headers: { Authorization: `Bearer ${token}` } })
                .then(res => {
    ...
    useEffect(() => {
        axios.get(`http://localhost:4000/managerHome/viewTasks/${userId}`, { headers: { Authorization: `Bearer ${token}` } })
            .then(res => {
                if (res.data.Status === "Success") {
    ...
    return (
        <div>
            <div className='d-flex justify-content-around p-3'>
                ...
                <Link href='/managerHome'><button className='btn btn-outline-success'>Back to ManangerHomepage</button></Link>
