...
export default function UserListByManger() {
    ...
    useEffect(() => {
        axios.get(`http://localhost:4000/usersList/${userId}`)
            .then(res => {
        ...
        <React.Fragment>
            <div>
                <div className='d-flex justify-content-around p-3'>
                    ...
                    <Link href='/adminHome/managerList'><button className='btn btn-outline-success'>Back to ManangerList</button></Link>
                </div>
                <div>
